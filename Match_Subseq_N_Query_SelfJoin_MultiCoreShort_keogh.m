function wholetime = Match_Subseq_N_Query_SelfJoin_MultiCoreShort_keogh(subFoldersTarget, subSeqLen, kNN_Uwant)
...
[keep_KNN_Dist_ToQuery, keep_KNN_Index_ToQuery] = SingleSeries_Par_STOMP_MP(keepAllTargetTogether, subSeqLen, kNN_Uwant, startFiles, endFiles);
