function [wholetime] = Match_Big_Data_Exp1(subFoldersTarget, querySeqComplete, subSeqLen,kNN_Uwant, whichDimToConsider, whichAlgoToConsider)
...
parfor divFilesInCluster = 1:1:n_work
    ...
    [keep_KNN_Dist_ToQuery, keep_KNN_Index_ToQuery, keepDataFileInfo] = ...
        ...
        subSeqLen, kNN_Uwant, whichDimToConsider, startFiles, endFiles,whichAlgoToConsider);
...
if(whichAlgoToConsider == "sortBased")
    [keep_KNN_Dist_ToQuery, keep_KNN_Index_ToQuery] = CalculateMatrixProfile_Par(keepAllTargetTogether, querySeqComplete', subSeqLen, ...
        kNN_Uwant,whichDimToConsider, validSubSeq);
elseif (whichAlgoToConsider == "maxBased")
    [keep_KNN_Dist_ToQuery, keep_KNN_Index_ToQuery] = CalculateMatrixProfile_ParMax(keepAllTargetTogether, querySeqComplete', subSeqLen, ...
        kNN_Uwant,whichDimToConsider, validSubSeq);
