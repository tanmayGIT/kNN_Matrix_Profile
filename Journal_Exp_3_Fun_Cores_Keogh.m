function Journal_Exp_3_Fun_Cores_Keogh(datasetName, savingPathFileName)

 % this is for self join where the number of cores will be varying for keogh algo
  ...
  nCores = 2;	
  while (nCores < 37)
      wholetime = Match_SelfJoin_Cores_keogh(keepTargetData, subSeqLen, kNN_Uwant, nCores); % working for the 2nd column here
