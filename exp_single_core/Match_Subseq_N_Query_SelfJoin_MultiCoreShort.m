function wholetime = Match_Subseq_N_Query_SelfJoin_MultiCoreShort(subFoldersTarget, subSeqLen, kNN_Uwant)
...
[keep_KNN_Dist_ToQuery, keep_KNN_Index_ToQuery] = SingleSeries_ParMaxHeapBased(keepAllTargetTogether, subSeqLen, kNN_Uwant, 1, length(keepAllTargetTogether));
