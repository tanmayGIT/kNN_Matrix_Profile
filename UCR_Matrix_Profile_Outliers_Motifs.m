...
for ii = 1:1:length(queryIndex)
    ...
    if(~badFlag) % if this flag remains false
        ...
        keepAllQueryInfo{cntEnter,1}.SortedVal_1NN_2NN = sortedVal1NN2NN(1, 1:20);
        keepAllQueryInfo{cntEnter,1}.SortedIndx_1NN_2NN = sortedIndx1NN2NN(1, 1:20);

        keepAllQueryInfo{cntEnter,1}.SortedVal_1NN_4NN = sortedVal1NN4NN(1, 1:20);
        keepAllQueryInfo{cntEnter,1}.SortedIndx_1NN_4NN = sortedIndx1NN4NN(1, 1:20);
